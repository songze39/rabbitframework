...
import com.rabbitframework.commons.crypto.RandomNumberGenerator;
 ...
 * {@link #setRandomNumberGenerator(RandomNumberGenerator) randomNumberGenerator} property.
...
public class DefaultHashService implements ConfigurableHashService {
     ...
     * <li>{@link #setRandomNumberGenerator(RandomNumberGenerator) randomNumberGenerator} =
