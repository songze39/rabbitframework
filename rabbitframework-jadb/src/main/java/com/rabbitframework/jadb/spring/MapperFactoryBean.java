 ...
 * <pre class="code">
 * {@code
 *   <bean id="baseMapper" class="com.rabbitframework.jadb.spring.MapperFactoryBean" abstract="true" lazy-init="true">
 *     <property name="rabbitJadbFactory" ref="rabbitJadbFactory" />
 *   </bean>
 *
...
public class MapperFactoryBean<T> implements FactoryBean<T>, InitializingBean {
	...
	public void setRabbitJadbFactory(RabbitJadbFactory rabbitJadbFactory) {
		this.sqlDataAccess = rabbitJadbFactory.openSqlDataAccess();
	}
