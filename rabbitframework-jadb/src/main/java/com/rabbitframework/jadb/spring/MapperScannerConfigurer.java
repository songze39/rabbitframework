...
public class MapperScannerConfigurer implements
	...
	private String rabbitJadbFactoryBeanName;
	...
	public void setRabbitJadbFactoryBeanName(String rabbitJadbFactoryBeanName) {
		this.rabbitJadbFactoryBeanName = rabbitJadbFactoryBeanName;
	}
	...
	public void postProcessBeanDefinitionRegistry(
		...
		scanner.setRabbitJadbFactoryBeanName(this.rabbitJadbFactoryBeanName);
	...
	private void processPropertyPlaceHolders() {
		...
		if (!prcs.isEmpty()
			...
			this.rabbitJadbFactoryBeanName = updatePropertyValue(
					"rabbitJadbFactoryBeanName", values);
		}
	}
