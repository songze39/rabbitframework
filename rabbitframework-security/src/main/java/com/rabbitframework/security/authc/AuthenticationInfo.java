 ...
 * has a parallel {@link com.rabbitframework.security.authz.AuthorizationInfo AuthorizationInfo} interface for use during the
 * authorization process that references access control data such as roles and permissions.
 * <p/>
 * But because many if not most {@link com.rabbitframework.security.realm.Realm Realm}s store both sets of data for a Subject, it might be
 ...
 *
 * @see com.rabbitframework.security.authz.AuthorizationInfo AuthorizationInfo
 * @see Account
 * @since 0.9
 */
