 ...
 * {@link com.rabbitframework.security.authc.credential.CredentialsMatcher credentials matching} during login attempts.
 * See the {@link com.rabbitframework.security.authc.credential.HashedCredentialsMatcher HashedCredentialsMatcher} JavaDoc for
 * more information on hashing credentials with salts.
 *
 * @see com.rabbitframework.security.authc.credential.HashedCredentialsMatcher
 *
 * @since 1.1
 */
