 ...
 * {@link com.rabbitframework.security.authz.permission.PermissionResolver PermissionResolver}</li>
 ...
 * {@link com.rabbitframework.security.authc.AuthenticationInfo AuthenticationInfo} interface for use during the authentication
 * process that represents identity data such as principals and credentials.
 * <p/>
 * Because many if not most {@link com.rabbitframework.security.realm.Realm Realm}s store both sets of data for a Subject, it might be
 * convenient for a <code>Realm</code> implementation to utilize an implementation of the
 * {@link com.rabbitframework.security.authc.Account Account} interface instead, which is a convenience interface that combines both
 ...
 *
 * @see com.rabbitframework.security.authc.AuthenticationInfo AuthenticationInfo
 * @see com.rabbitframework.security.authc.Account
 * @since 0.9
 */
public interface AuthorizationInfo extends Serializable {
     ...
     * {@link com.rabbitframework.security.authz.permission.PermissionResolver PermissionResolver}
