 ...
 * {@link com.rabbitframework.security.subject.Subject Subject} determines that the
 ...
 * an {@link com.rabbitframework.security.authz.AuthorizationException AuthorizationException} will be thrown.
 *
 * @see com.rabbitframework.security.subject.Subject#checkPermission
 * @since 0.1
 */
...
public @interface RequiresPermissions {
    ...
    /**
     * The permission string which will be passed to {@link com.rabbitframework.security.subject.Subject#isPermitted(String)}
