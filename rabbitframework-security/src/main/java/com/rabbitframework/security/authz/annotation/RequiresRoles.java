...
/**
 * Requires the currently executing {@link com.rabbitframework.security.subject.Subject Subject} to have all of the 
 * specified roles. If they do not have the role(s), the method will not be executed and
 * an {@link com.rabbitframework.security.authz.AuthorizationException AuthorizationException} is thrown.
 * <p/>
 * For example,
 * <p/>
 ...
 *
 * @see com.rabbitframework.security.subject.Subject#hasRole(String)
 * @since 0.1
 */
