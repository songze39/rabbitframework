...
import com.rabbitframework.security.aop.MethodInvocation;
...
public abstract class AnnotationsAuthorizingMethodInterceptor extends AuthorizingMethodInterceptor {
     ...
     * <p/>
     * Unless overridden by the {@link #setMethodInterceptors(Collection)} method, the default collection
     * contains a
     ...
     * {@link AuthorizingAnnotationMethodInterceptor#supports(MethodInvocation) supports}
     * the invocation, that the interceptor
     * {@link AuthorizingAnnotationMethodInterceptor#assertAuthorized(MethodInvocation) asserts}
