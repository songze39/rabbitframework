...
import com.rabbitframework.security.aop.MethodInterceptorSupport;
...
public abstract class AuthorizingMethodInterceptor extends MethodInterceptorSupport {
    ...
    /**
     * Invokes the specified method (<code>methodInvocation.{@link MethodInvocation#proceed proceed}()</code>
     * if authorization is allowed by first
     * calling {@link #assertAuthorized(MethodInvocation) assertAuthorized}.
     */
