...
import com.rabbitframework.security.authz.annotation.RequiresGuest;
 ...
 * <p>
 * This annotation essentially ensures that <code>subject.{@link com.rabbitframework.security.subject.Subject#getPrincipal() getPrincipal()} == null</code>.
 *
 * @since 0.9.0
 */
public class GuestAnnotationHandler extends AuthorizingAnnotationHandler {
     ...
     * have an {@link com.rabbitframework.security.subject.Subject#getPrincipal() identity} before continuing.  If they are
     * a user ({@link com.rabbitframework.security.subject.Subject#getPrincipal() Subject.getPrincipal()} != null), an
