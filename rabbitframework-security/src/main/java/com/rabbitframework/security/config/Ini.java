 ...
 * <a href="http://en.wikipedia.org/wiki/INI_file">INI</a> text configuration
 * format.
 * <p/>
 * An Ini instance is a map of {@link Section Section}s, keyed by section name.
 * Each {@code Section} is itself a map of {@code String} name/value pairs.
 * Name/value pairs are guaranteed to be unique within each {@code Section} only
 * - not across the entire {@code Ini} instance.
 *
 * @since 1.0
 */
@Deprecated
