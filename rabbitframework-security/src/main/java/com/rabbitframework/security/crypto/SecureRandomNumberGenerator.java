...
/**
 * Default implementation of the {@link RandomNumberGenerator
 * RandomNumberGenerator} interface, backed by a {@link SecureRandom
 * SecureRandom} instance.
 * <p/>
 * This class is a little easier to use than using the JDK's
 * {@code SecureRandom} class directly. It also allows for JavaBeans-style of
 * customization, convenient for Shiro's INI configuration or other IoC
...
public class SecureRandomNumberGenerator implements RandomNumberGenerator {
	...
	protected static final int DEFAULT_NEXT_BYTES_SIZE = 16; // 16 bytes == 128
																// bits (a
																// common number
																// in crypto)
	...
	/**
	 * Creates a new instance with a default backing {@link SecureRandom
	 * SecureRandom} and a {@link #getDefaultNextBytesSize()
	 * defaultNextBytesSize} of {@code 16}, which equals 128 bits, a size
	 * commonly used in cryptographic algorithms.
	 */
	...
	/**
	 * Seeds the backing {@link SecureRandom SecureRandom} instance with
	 ...
	 *
	 * @param random
	 *            the {@link SecureRandom SecureRandom} to back this instance.
	...
	public void setSecureRandom(SecureRandom random)
		...
		if (random == null) {
			throw new NullPointerException(
					"SecureRandom argument cannot be null.");
		}
	 ...
	 * {@link #nextBytes() nextBytes()}. Defaults to {@code 16}, which equals
	 * 128 bits, a size commonly used in cryptographic algorithms.
	 *
	 * @return the size of the generated byte array for calls to
	 *         {@link #nextBytes() nextBytes()}.
	 */
	...
	public void setDefaultNextBytesSize(int defaultNextBytesSize)
		...
		if (defaultNextBytesSize <= 0) {
			throw new IllegalArgumentException(
					"size value must be a positive integer (1 or larger)");
		}
