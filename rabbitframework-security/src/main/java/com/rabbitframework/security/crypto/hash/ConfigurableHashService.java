...
public interface ConfigurableHashService extends HashService {
	 ...
	 *
	 * @param privateSalt
	 *            the 'private' internal salt to be paired with a 'public'
	 ...
	 *
	 * @param iterations
	 *            the number of hash iterations that will be performed during
	 *            hash computation.
	 */
	 ...
	 *
	 * @param name
	 *            the name of the {@link java.security.MessageDigest
	 ...
	 *
	 * @param rng
	 *            a source of randomness used to generate public salts that will
	 *            in turn be used during hash computation.
	 */
