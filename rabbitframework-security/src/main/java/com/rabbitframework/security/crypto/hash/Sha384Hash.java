...
/**
 * Generates an SHA-384 Hash from a given input <tt>source</tt> with an optional
 * <tt>salt</tt> and hash iterations.
 * <p/>
 ...
 * function.
 * <p/>
 * <b>JDK Version Note</b> - Attempting to instantiate this class on JREs prior
 * to version 1.4.0 will throw an {@link IllegalStateException
