...
public class DefaultSecurityManager extends SessionsSecurityManager {
     ...
     * <p/>
     * As of Shiro 1.2, this method has been deprecated in favor of {@link #save(com.rabbitframework.security.subject.Subject)},
     ...
     * @deprecated in favor of {@link #save(com.rabbitframework.security.subject.Subject) save(subject)}.
     */
    @Deprecated
     ...
     * <li>Calls {@link #doCreateSubject(com.rabbitframework.security.subject.SubjectContext)} to actually perform the
     * {@code Subject} instance creation.</li>
     * <li>calls {@link #save(com.rabbitframework.security.subject.Subject) save(subject)} to ensure the constructed
     ...
     * {@link SubjectDAO#save(com.rabbitframework.security.subject.Subject) subjectDAO.save(subject)}.
     *
     ...
     * <p/>
     * This implementation merely delegates to the internal {@link #setSubjectDAO(SubjectDAO) subjectDAO} and calls
     * {@link SubjectDAO#delete(com.rabbitframework.security.subject.Subject) delete(subject)}.
     *
