 ...
 * <p/>
 * The template can be configured directly via the {@link #getEnvironment()}/{@link #setEnvironment(Map)}
...
public class JndiLdapContextFactory implements LdapContextFactory {
     ...
     * {@link #createLdapContext(Hashtable) created} and returned.
     *
    ...
    /**
     * Creates and returns a new {@link InitialLdapContext} instance.  This method exists primarily
        ...
        if(SIMPLE_AUTHENTICATION_MECHANISM_NAME.equals(environment.get(Context.SECURITY_AUTHENTICATION))) {
            ...
            if( environment.get(Context.SECURITY_PRINCIPAL) != null &&
                ...
                if( credentials == null ||
                    ...
                    throw new AuthenticationException("LDAP Simple authentication requires both a "
