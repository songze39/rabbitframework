 ...
 * under the License.
 */
package com.rabbitframework.security.realm.ldap;
...
import com.rabbitframework.security.authc.credential.AllowAllCredentialsMatcher;
...
import com.rabbitframework.security.ldap.UnsupportedAuthenticationMechanismException;
...
/**
 * An LDAP {@link com.rabbitframework.security.realm.Realm Realm} implementation utilizing Sun's/Oracle's
 ...
 * {@link AuthenticationToken#getPrincipal() principal} is a simple username, but the
...
public class JndiLdapRealm extends AuthorizingRealm {
    ...
    ============================================*/
    /**
     * The LdapContextFactory instance used to acquire {@link LdapContext LdapContext}'s at runtime
