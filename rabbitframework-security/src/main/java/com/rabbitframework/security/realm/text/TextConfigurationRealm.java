 ...
 * under the License.
 */
package com.rabbitframework.security.realm.text;

import com.rabbitframework.security.authc.SimpleAccount;
import com.rabbitframework.security.authz.Permission;
import com.rabbitframework.security.authz.SimpleRole;
...
import com.rabbitframework.security.util.PermissionUtils;
...
public class TextConfigurationRealm extends SimpleAccountRealm {
     ...
     * Strings that conform to the {@link com.rabbitframework.security.authz.permission.WildcardPermission WildcardPermission}
