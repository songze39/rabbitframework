...
import com.rabbitframework.security.session.mgt.eis.MemorySessionDAO;
import com.rabbitframework.security.session.mgt.eis.SessionDAO;
...
/**
 * Default business-tier implementation of a {@link ValidatingSessionManager}.
 * All session CRUD operations are delegated to an internal {@link SessionDAO}.
 *
 * @since 0.1
 */
public class DefaultSessionManager extends AbstractValidatingSessionManager implements CacheManagerAware {
	...
	protected SessionDAO sessionDAO; // todo - move SessionDAO up to
	 ...
	 * store.
	 * <h4>Usage</h4> It is ok to set this to {@code false} <b><em>ONLY</em></b>
	 * if you have some other process that you manage yourself that periodically
	 * deletes invalid sessions from the backing data store over time, such as
	 * via a Quartz or Cron job. If you do not do this, the invalid sessions
	 * will become 'orphans' and fill up the data store over time.
	 * <p/>
	 ...
	 * implements the {@link CacheManagerAware CacheManagerAware} interface.
	 * <p/>
	 * This method is called after setting a cacheManager via the
	 * {@link #setCacheManager(CacheManager) setCacheManager} method <em>em</em>
	 * when setting a {@code SessionDAO} via the {@link #setSessionDAO} method
	 * to allow it to be propagated in either case.
	 *
	 * @since 1.0
	 */
