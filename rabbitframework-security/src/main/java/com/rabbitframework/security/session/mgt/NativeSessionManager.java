 ...
 * for the creation, persistence and removal of {@link com.rabbitframework.security.session.Session Session} instances and their
 * lifecycles.
 *
 * @since 1.0
 */
public interface NativeSessionManager extends SessionManager {
     ...
     * @throws InvalidSessionException if the specified session has stopped or expired prior to calling this method.
     * @see com.rabbitframework.security.session.Session#setAttribute(Object key, Object value)
     */
     ...
     * @throws InvalidSessionException if the specified session has stopped or expired prior to calling this method.
     * @see com.rabbitframework.security.session.Session#removeAttribute(Object key)
     */
