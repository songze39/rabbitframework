...
import com.rabbitframework.security.session.StoppedSessionException;
...
/**
 * Simple {@link com.rabbitframework.security.session.Session} JavaBeans-compatible POJO implementation, intended to be used on the
