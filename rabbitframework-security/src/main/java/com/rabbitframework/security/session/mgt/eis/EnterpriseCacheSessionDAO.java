 ...
 * under the License.
 */
package com.rabbitframework.security.session.mgt.eis;

import com.rabbitframework.security.cache.AbstractCacheManager;
import com.rabbitframework.security.cache.Cache;
import com.rabbitframework.security.cache.CacheException;
import com.rabbitframework.security.cache.MapCache;
 ...
 * It is expected that an injected {@link Cache Cache} or
 * {@link com.rabbitframework.security.cache.CacheManager CacheManager} is backed by an enterprise caching product that can support
