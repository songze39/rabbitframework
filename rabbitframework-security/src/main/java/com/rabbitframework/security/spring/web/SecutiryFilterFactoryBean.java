 ...
 * TODO 待开发
 *
 * security权限框架spring注入工厂类,主要定义了框架过滤器,实现{@link FactoryBean}、{@link BeanPostProcessor}
 * <h4>使用说明</h4>
 * 在{@code web.xml}中声明DelegatingFilterProxy, 过滤器名称与bean的id一致:
 * <pre>
 * &lt;filter&gt;
 ...
 */
public class SecutiryFilterFactoryBean implements FactoryBean, BeanPostProcessor {
    /**
     * 实现{@link FactoryBean}
     *
     * @return
