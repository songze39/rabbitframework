 ...
 * {@link com.rabbitframework.security.mgt.SubjectFactory SubjectFactory} implementation to construct {@code Subject} instances.
 ...
 * way.
 *
 * @see SecurityManager#createSubject SecurityManager.createSubject
 * @see com.rabbitframework.security.mgt.SubjectFactory SubjectFactory
 * @since 1.0
 */
public interface SubjectContext extends Map<String, Object> {
     ...
     * (typically used to support {@link com.rabbitframework.security.subject.support.DelegatingSubject DelegatingSubject} implementations).
     *
     ...
     * instance (typically used to support {@link com.rabbitframework.security.subject.support.DelegatingSubject DelegatingSubject} implementations).
     *
