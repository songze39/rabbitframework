 ...
 * This ensures that any calls to {@code SecurityUtils.}{@link com.rabbitframework.security.SecurityUtils#getSubject() getSubject()}
 ...
 * {@link com.rabbitframework.security.concurrent.SubjectAwareExecutorService SubjectAwareExecutorService}, which
 * transparently uses instances of this class.
 *
 * @see Subject#associateWith(Callable)
 * @see com.rabbitframework.security.concurrent.SubjectAwareExecutorService SubjectAwareExecutorService
 * @since 1.0
 */
