 ...
 * call to {@code SecurityUtils.}{@link com.rabbitframework.security.SecurityUtils#getSubject() getSubject()} during the
 ...
 * {@link com.rabbitframework.security.concurrent.SubjectAwareExecutor SubjectAwareExecutor}, which transparently uses
 * instances of this class but does not require referencing Shiro's API at all.
 *
 * @see Subject#associateWith(Runnable)
 * @see com.rabbitframework.security.concurrent.SubjectAwareExecutor SubjectAwareExecutor
 * @since 1.0
 */
