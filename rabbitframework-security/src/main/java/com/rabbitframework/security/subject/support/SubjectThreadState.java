 ...
 * {@code SecurityUtils.}{@link com.rabbitframework.security.SecurityUtils#getSubject() getSubject()} calls)
 * during a thread's execution.
 * <p/>
 * The {@link #bind bind} method will bind a {@link Subject} and a
 * {@link SecurityManager SecurityManager} to the {@link ThreadContext} so they can be retrieved
 * from the {@code ThreadContext} later by any
 * {@code SecurityUtils.}{@link com.rabbitframework.security.SecurityUtils#getSubject() getSubject()} calls that might occur during
...
public class SubjectThreadState implements ThreadState {
     ...
     * {@code SecurityUtils.}{@link com.rabbitframework.security.SecurityUtils#getSubject() getSubject()} calls that might occur
