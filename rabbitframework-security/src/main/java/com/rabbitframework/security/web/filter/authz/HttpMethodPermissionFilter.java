 ...
 * {@link com.rabbitframework.security.web.filter.PathMatchingFilter currently matching path}.</li>
 * <li>If the current {@code Subject} {@link com.rabbitframework.security.subject.Subject#isPermitted(String) isPermitted} to
...
public class HttpMethodPermissionFilter extends PermissionsAuthorizationFilter {
     ...
     * to each one per {@link com.rabbitframework.security.authz.permission.WildcardPermission WildcardPermission} conventions.  The
     ...
     * </ol>
     * per {@link com.rabbitframework.security.authz.permission.WildcardPermission WildcardPermission} conventions.  Subclasses
