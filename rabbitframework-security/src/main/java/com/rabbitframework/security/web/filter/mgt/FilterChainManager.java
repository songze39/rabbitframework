...
public interface FilterChainManager {
     ...
     * (such as an {@link com.rabbitframework.security.util.AntPathMatcher Ant path expression}).  For example:
     * <p/>
     ...
     * @see com.rabbitframework.security.util.AntPathMatcher AntPathMatcher
     */
     ...
     * a {@link com.rabbitframework.security.web.filter.PathConfigProcessor PathConfigProcessor} to accept per-chain configuration.
     ...
     *                                  {@link com.rabbitframework.security.web.filter.PathConfigProcessor PathConfigProcessor}
     *                                  interface).
     */
