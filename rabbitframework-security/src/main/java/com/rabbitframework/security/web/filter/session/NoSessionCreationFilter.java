 ...
 * under the License.
 */
package com.rabbitframework.security.web.filter.session;

import com.rabbitframework.security.subject.support.DefaultSubjectContext;
import com.rabbitframework.security.web.filter.PathMatchingFilter;
 ...
 * disables all calls to {@code subject}.{@link com.rabbitframework.security.subject.Subject#getSession() getSession()} and
 * {@code subject}.{@link com.rabbitframework.security.subject.Subject#getSession(boolean) getSession(true)}.  If either are called
