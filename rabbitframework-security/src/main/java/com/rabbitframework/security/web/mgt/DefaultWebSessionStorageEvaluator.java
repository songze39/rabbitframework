 ...
 * {@link com.rabbitframework.security.web.filter.session.NoSessionCreationFilter}:  If the {@code NoSessionCreationFilter}
 ...
 * {@code false} from {@link #isSessionStorageEnabled(com.rabbitframework.security.subject.Subject)} method, thereby preventing
