...
import com.rabbitframework.security.web.env.WebEnvironment;
 ...
 * {@link com.rabbitframework.security.web.env.EnvironmentLoaderListener EnvironmentLoaderListener}, which performs the necessary
 * environment setup.  For example:
 * <pre>
 * &lt;listener&gt;
 *     &lt;listener-class&gt;{@link com.rabbitframework.security.web.env.EnvironmentLoaderListener}&lt;/listener-class&gt;
 * &lt;/listener&gt;
 * ...
 * &lt;filter&gt;
 ...
 * {@link com.rabbitframework.security.web.env.EnvironmentLoader EnvironmentLoader} JavaDoc for configuration options.
 *
 * @see com.rabbitframework.security.web.env.EnvironmentLoader EnvironmentLoader
 * @see com.rabbitframework.security.web.env.EnvironmentLoaderListener EnvironmentLoaderListener
...
public class SecurityFilter extends AbstractSecurityFilter {
     ...
     *
     * @see com.rabbitframework.security.web.env.EnvironmentLoaderListener
     * @since 1.2
     */
    @Override
