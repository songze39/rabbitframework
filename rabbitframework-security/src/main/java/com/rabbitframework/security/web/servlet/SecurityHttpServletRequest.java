...
import com.rabbitframework.security.subject.support.DisabledSessionException;
...
public class SecurityHttpServletRequest extends HttpServletRequestWrapper {
    ...
    //The following 7 constants support the Security's implementation of the Servlet Specification
